...
Artifacta is an open-source platform for hosting BI dashboards generated by coding agents. Build a polished HTML dashboard locally from CSV, JSON, warehouse data, or analysis scripts, then upload it to Artifacta so the rest of the team can view it through a secure, shareable workspace.
