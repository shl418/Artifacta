    ...
    data: database.dashboardVersions
      ...
      .map((version) => ({
        ...
        artifact: {
          ...
          revision_id: version.htmlArtifact.revisionId ?? null,
          entry_path: version.htmlArtifact.entryPath ?? null,
        },
        operation: version.operation ?? "upload",
        parent_revision_id: version.parentRevisionId ?? null,
        text_changes: (version.textChanges ?? []).map((change) => ({
